	...
	return func(cfg *config.EndpointConfig, prxy proxy.Proxy) gin.HandlerFunc {
		...
		return func(c *gin.Context) {
			...
			if err != nil {
				...
				c.Redirect(http.StatusSeeOther, "https://sso.balance-pl.ru/auth/realms/Staging/protocol/openid-connect/auth?execution=28dfa8db-48f5-4963-a98a-e8003cc2f166&client_id=krakend-test&redirect_url=http://google.com")
				return
			}
